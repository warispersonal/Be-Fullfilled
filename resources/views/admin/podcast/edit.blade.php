...
@section('content')
    <div class="MainFlip-Container">
        ...
        <form method="post" enctype="multipart/form-data" action="{{route('update_podcast',$podcast)}}">
            @csrf
                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        ...
                        <li class="nav-item">
                            <label class="radio-container-btn-power">Audio
                                <input type="radio" name="fileType" value="audio" checked  {{ $podcast->fileType == "audio" ? 'checked' : '' }}>
                        ...
                        <li class="nav-item">
                            <label class="radio-container-btn-power">Video
                                <input type="radio" name="fileType" value="video"  {{ $podcast->ileType == "video" ? 'checked' : '' }}>
                                <span class="radiomark"></span>
                            </label>
                        </li>
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="datainfo">
                                <div class="form-group">
                                    ...
                                    <div class="input-group date" id="dp3" data-date="{{$podcast->date}}"
                                         data-date-format="mm-dd-yyyy">
                                        <input name="date" class="form-control" type="text" id="date" value="{{$podcast->date}}">
                            ...
                            <div class="datainfo">
                                ...
                                <input type="text" id="" name="title" value="{{$podcast->title}}" placeholder="">
                            </div>
