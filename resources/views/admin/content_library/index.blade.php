            ...
            <div class="LibraryCon">
                ...
                <div class="LibraryLeft Thumb-margin">
                    <div class="MainThumb">
                        ...
                        <img src="{{asset('assets/images/library-img.png')}}" alt=""/>

                        <div class="Mainhead-Btm">
                            <div class="FreeCon"><h1>Free Content</h1></div>
                            <h1>Drainers and Drivers <img src="{{asset('assets/images/table-dotted.svg')}}" alt=""/>
                            </h1>
                ...
                <div class="LibraryLeft">
                    <div class="MainThumb">
                        ...
                        <img src="{{asset('assets/images/library-img-2.png')}}" alt=""/>

                        <div class="Mainhead-Btm">
                            <div class="FreeCon"><h1>Free Content</h1></div>
                            <h1>BeFulfilled Recovery <img src="{{asset('assets/images/table-dotted.svg')}}" alt=""/>
                            </h1>
                ...
                <div class="LibraryLeft Thumb-margin">
                    <div class="MainThumb">
                        ...
                        <img src="{{asset('assets/images/library-img-3.png')}}" alt=""/>
